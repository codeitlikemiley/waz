...
App icons are located in `app/channels/<channel_name>/icon/padded` (contains ~10% safe-area, shared between macOS dock and Linux/Windows).The `.ico` files are generated using imagemagick:
