//! AI Assistant has since been renamed to "Waz AI" in the product.
...
pub const AI_ASSISTANT_FEATURE_NAME: &str = "Waz AI";
pub const ASK_AI_ASSISTANT_TEXT: &str = "Ask Waz AI";
