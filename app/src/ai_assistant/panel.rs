...
const ZERO_STATE_HELP_TEXT: &str = "Shift + ctrl + space a block or text selection to ask Waz AI.";
...
pub fn init(app: &mut AppContext) {
    ...
    app.register_fixed_bindings([FixedBinding::custom(
        ...
        crate::t!("keybinding-desc-ai-assistant-close"),
        id!("AIAssistantPanel"),
    )]);
    ...
    app.register_editable_bindings([
        EditableBinding::new(
            ...
            crate::t!("keybinding-desc-ai-assistant-focus-terminal-input"),
        ...
        EditableBinding::new(
            ...
            crate::t!("keybinding-desc-ai-assistant-restart"),
