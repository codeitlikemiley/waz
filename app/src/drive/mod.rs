...
pub struct WazDriveObjectSettings {
    /// The folder that should be focused in the Waz Drive when the object is opened.
...
pub struct WazDriveObjectArgs {
    pub object_type: ObjectType,
    pub server_id: ServerId,
    pub settings: WazDriveObjectSettings,
}
...
/// Enum used for sorting elements in the Waz Drive Index (and potentially other places).
...
#[schemars(
    description = "Sort order for Waz Drive items.",
