...
impl WorkflowModal {
    /// Generates metadata for the command via BYOP one-shot completion, and applies the AI feedback
    /// directly to the corresponding fields of the modal editor. If no BYOP is configured → directly emits an error event.
