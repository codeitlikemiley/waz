...
// Waz Phase 2a: `dialog/` (cloud sharing modal UI) deleted along with
...
/// Identifier for an object that's shareable via the Waz Drive ACL model. Not all sharing in Waz
/// is _currently_ tied into this model (e.g. block sharing).
#[derive(Debug, Clone)]
pub enum ShareableObject {
    /// A shareable Waz Drive object.
