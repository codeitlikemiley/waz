...
/// The sidebar that houses Waz Drive.
/// `DrivePanel` is different from `DriveIndex` in that it is responsible for
/// how Waz Drive interacts with the workspace and the rest of the app, whereas
/// `DriveIndex` is the main waz drive view and responsible for the internals of Waz Drive.
...
impl DrivePanel {
    ...
    /// This functions scrolls the relevant Waz Drive item into view.
    ...
    /// This functions sets the index of a focused Waz Drive item.
