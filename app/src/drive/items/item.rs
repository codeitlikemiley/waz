...
/// A UI wrapper around a row in waz drive that holds important UI state for the row and implements
/// a unified look for all rows in waz drive, like padding and hover states.
///
...
/// Generate a callback for calculating the Drag bounds within Waz Drive
