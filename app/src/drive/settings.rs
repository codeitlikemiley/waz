...
define_settings_group!(WarpDriveSettings, settings: [
    sorting_choice: WarpDriveSortingChoice {
        ...
        description: "The sort order for items in Waz Drive.",
    },
    ...
    // Controls whether Waz Drive appears in the tools panel, command palette, and command search.
    enable_warp_drive: EnableWarpDrive {
        ...
        description: "Whether Waz Drive is enabled.",
    },
]);

impl WarpDriveSettings {
    /// Returns whether Waz Drive should be considered enabled.
