...
/// This enum is used to enforce options in the dropdown for selecting a separator with the Waz prompt.
/// Note that these separators are added at the END of the Waz prompt (used in the case of same line prompt).
#[derive(
    Clone,
    Copy,
    Debug,
