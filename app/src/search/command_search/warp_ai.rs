...
const OPEN_WARP_AI_ITEM_BODY_TEXT: &str = "Ask Waz AI for command suggestions";
const TRANSLATE_WITH_WARP_AI_ITEM_BODY_TEXT: &str = "Translate into shell command using Waz AI";
...
impl SearchItem for WarpAISearchItem {
    ...
    fn render_icon(
        ...
        // Since the Waz AI logo color is hardcoded, let's find the best
    ...
    fn accept_result(&self) -> CommandSearchItemAction {
        match self {
            ...
            WarpAISearchItem::Open => CommandSearchItemAction::WazAI,
        }
    }
    ...
    fn accessibility_label(&self) -> String {
        format!("Waz AI: {}", self.item_body_text())
    }
}

/// Waz only keeps synchronous entry points: opening the BYOP Agent or writing natural language back to the input box.
/// The cloud-based "natural language command generation" asynchronous source has been removed.
