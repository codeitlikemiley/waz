...
pub trait StoredStringObject: StoredObject + Send + Sync {
    ...
    /// We cannot directly require this trait to derive Clone; otherwise, the trait is no longer object-safe.
...
/// By implementing this trait, most local object-store behaviors can be reused.
///
/// Objects implementing this type share the same set of local storage behaviors.
