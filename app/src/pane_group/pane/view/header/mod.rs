...
impl<P: BackingView> PaneHeader<P> {
    ...
    fn render_right_justified_row(
        ...
        // Waz Phase 2a: sharing controls removed from the header.
    ...
    /// Adds overlay children to the stack (overflow menu only — sharing
    /// dialog removed in Phase 2a).
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let header_ctx = HeaderRenderContext {
            ...
            render_sharing_controls_fn: Box::new(|_app, _icon_color, _button_size| {
                // Waz Phase 2a: sharing controls removed.
                None
            }),
        };
