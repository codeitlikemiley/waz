...
// 16 colors ANSI aligned with background/foreground WezTerm default color; accent color #52AD70 is self-selected for this project and is not a WezTerm standard color.
