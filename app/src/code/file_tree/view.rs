...
impl FileTreeView {
    ...
    fn render_item(&self, id: &FileTreeIdentifier, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let hoverable = Hoverable::new(render_state.mouse_state.clone(), move |mouse_state| {
            ...
            // Remote files are already supported to be opened via the buffer-sync protocol, no longer showing the "Cannot open" prompt.
        ...
        // Both local and remote files can be clicked to open, uniformly using the pointing hand cursor.
    ...
    fn context_menu_items(
            ...
            match item {
                FileTreeItem::File { .. } => {
                    ...
                    if !is_file_content_binary(&path_local) {
                        items.extend([
                            MenuItemFields::new(crate::t!("menu-filetree-open-in-new-pane"))
                                .with_on_select_action(FileTreeAction::OpenInNewPane {
                                    id: id.clone(),
                                })
                                .into_item(),
                            MenuItemFields::new(crate::t!("menu-filetree-open-in-new-tab"))
                        ...
                        items.push(
                            MenuItemFields::new(crate::t!("menu-filetree-open-file"))
                ...
                FileTreeItem::DirectoryHeader { .. } => {
                    items.push(
                        MenuItemFields::new(crate::t!("menu-filetree-new-file"))
        ...
        if self.has_terminal_session {
            ...
            items.push(
                MenuItemFields::new(crate::t!("menu-filetree-attach-as-context"))
        ...
        items.extend([
            MenuItemFields::new(crate::t!("menu-filetree-copy-path"))
                .with_on_select_action(FileTreeAction::CopyPath { id: id.clone() })
                .into_item(),
            MenuItemFields::new(crate::t!("menu-filetree-copy-relative-path"))
...
pub enum FileTreeEvent {
    ...
    /// Emitted when a file is clicked in the remote file tree, requesting to open it as a remote buffer.
