...
pub fn init(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            crate::t!("keybinding-desc-editor-move-to-line-start-short"),
            CodeEditorViewAction::MoveToLineStart,
        )
        .with_context_predicate(text_entry.clone())
        ...
        EditableBinding::new(
            ...
            crate::t!("keybinding-desc-editor-move-to-line-end-short"),
            CodeEditorViewAction::MoveToLineEnd,
        )
        .with_context_predicate(text_entry.clone())
        ...
        EditableBinding::new(
            ...
            crate::t!("keybinding-desc-editor-cursor-at-buffer-start"),
        ...
        EditableBinding::new(
            ...
            crate::t!("keybinding-desc-editor-cursor-at-buffer-end"),
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            crate::t!("keybinding-desc-editor-toggle-comment"),
    ...
    app.register_editable_bindings([EditableBinding::new(
        "code_editor:find",
        crate::t!("keybinding-desc-editor-find-in-code-editor"),
    ...
    app.register_editable_bindings([EditableBinding::new(
        ...
        crate::t!("keybinding-desc-editor-go-to-line"),
