...
/// user to have logged in, or for the initial load of Waz Drive objects to have finished). When
...
///
/// We use this in Waz Drive to wait for the initial load of changed objects to finish. Regular UI
