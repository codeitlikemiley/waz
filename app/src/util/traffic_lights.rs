...
//! depends on the platform. The Waz app must use this information to avoid rendering UI elements
//! underneath them.
...
/// Data the Waz app needs to avoid rendering anything below the traffic lights.
#[derive(Clone, Debug)]
