...
pub const EDUCATION_TEXT: &str = "Add secret or command. Waz never stores external secrets";
...
impl EnvVarCollectionView {
    ...
    pub fn load(
        ...
        // ShareableObject injection of env_var_collection is removed; ServerId path remains to be
        // cloud_object is retired as a whole.
