...
impl EnvVarCollectionManager {
    pub fn new(_ctx: &mut ModelContext<Self>) -> Self {
        // Waz: Same as WorkflowManager — client_id→server_id conversion event is only triggered after the cloud is successfully created.
        // Waz cloudless = never triggered. Phase 2c‑1 removes UpdateManager subscription and death handler functions.
