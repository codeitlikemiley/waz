...
// openWarp: auto-approve(ctrl+shift+i) only automatically approves shell/edit tools,
// ask_user_question must still be shown to the user even in autoapprove mode.
#[test]
