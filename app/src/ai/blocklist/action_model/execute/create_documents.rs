...
impl CreateDocumentsExecutor {
    ...
    pub(super) fn execute(
        ...
        let created_documents: Vec<DocumentContext> = documents
            ...
            .map(|(index, document)| {
                ...
                let artifact = Artifact::Plan {
                    ...
                    notebook_uid: None, // openWarp does not sync to cloud notebook, always None; local opening uses document_uid
        ...
        // openWarp no longer pushes the plan to Waz Drive; plan content has already been
        // written to the local SQLite ai_document_panes table via AIDocumentModel::enqueue_save,
        // allowing the user to view and edit it directly in the right pane.
