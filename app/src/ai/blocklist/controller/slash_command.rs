...
pub enum SlashCommandRequest {
    ...
    Summarize {
        ...
        /// chat_stream::SummarizeConversation branch decides follow-up copywriting accordingly
        /// (The overflow path will spell a "previous request exceeded..." explanation).
        /// /compact /compact-and is false when triggered manually; true for auto-trigger path.
        overflow: bool,
    },
    FetchReviewComments {
        repo_path: String,
