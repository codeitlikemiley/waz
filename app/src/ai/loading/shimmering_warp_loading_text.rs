//! Shimmering Waz loading text - renders Waz logo with shimmering text for loading states.
...
/// Waz icon glyph character
const WARP_GLYPH: &str = "\u{E500}";

/// Creates a shimmering text element with the Waz glyph.
