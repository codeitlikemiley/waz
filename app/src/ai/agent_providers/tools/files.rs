...
//!
//! Corresponding to `api::message::tool_call::Tool::ReadFiles` in warp,
//! After execution, the result is `ToolCallResultType::ReadFiles(ReadFilesResult)`.
            ...
            "files": {
                ...
                "items": {
                    ...
                    "properties": {
                        "path": {
                            "type": "string",
                            "description": "File path (can be relative to the current working directory or absolute)."
                        },
                        "line_ranges": {
                            "type": "array",
                            "description": "Optional list of line ranges (1-based, inclusive). If empty, the entire file is read.",
                            "items": {
                                "type": "object",
                                "properties": {
                                    "start": {"type": "integer"},
