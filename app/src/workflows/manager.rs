...
impl WorkflowManager {
    pub fn new(_ctx: &mut ModelContext<Self>) -> Self {
        // Waz: No cloud = No client_id→server_id conversion event, original UpdateManager
        // Subscription + handle_update_manager_event is dead code, deleted in Phase 2c‑1.
        WorkflowManager {
