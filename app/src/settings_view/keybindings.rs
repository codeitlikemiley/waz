...
// Retained placeholder copy for reuse by `resource_center/keybindings_page.rs`;
// Will migrate to fluent when that file is individually internationalized.
...
// Other user-facing strings are retrieved at runtime via crate::t!(), see settings-keybindings-* fluent keys.
