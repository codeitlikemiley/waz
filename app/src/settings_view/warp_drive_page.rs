...
impl From<ViewHandle<WarpDriveSettingsPageView>> for SettingsPageViewHandle {
    fn from(view_handle: ViewHandle<WarpDriveSettingsPageView>) -> Self {
        SettingsPageViewHandle::WazDrive(view_handle)
    }
}
...
impl SettingsWidget for WarpDriveToggleWidget {
    ...
    fn search_terms(&self) -> &str {
        "waz drive tools panel command palette search workflows prompts notebooks environment variables"
    }
    ...
    fn render(
        ...
        render_body_item::<WarpDriveSettingsPageAction>(
            ...
            appearance
                ...
                .finish(),
            Some("Waz Drive is a local workspace in your terminal where you can save Workflows, Notebooks, Prompts, and Environment Variables on this device.".into()),
        )
    }
}
