...
// Literals have been migrated to Fluent: `settings-external-editor-tabbed-header` /
...
impl ExternalEditorView {
    ...
    fn init_editor_dropdown(
        ...
        match editor_to_open_files {
            ...
            EditorChoice::Waz => dropdown.set_selected_by_name(crate::t!("app-name"), ctx),
