...
impl View for ExecutionProfileView {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        // The title model falls back to the display name of the base model; matching the base model indicates "not set independently".
        ...
        // The active AI model (used for prompt suggestions / NLD / relevant files), falls back to the base model.
        ...
        // The Next Command model (used for inline autocomplete / zero-state suggestions), falls back to the base model.
