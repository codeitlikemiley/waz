...
impl RepoPicker {
    ...
    pub fn new_with_style(
        ...
        // PersistedWorkspace has been offline and no longer subscribes to the "WorkspaceAdded" event.
        // The dropdown list is always empty, leaving only the `+ Add new repo...` ​​button at the bottom.
    ...
    fn refresh_items(&mut self, select_path: Option<&str>, ctx: &mut ViewContext<Self>) {
        // PersistedWorkspace has been offline, and there is no longer a candidate source for "previously opened git repository".
        // The dropdown list is always empty, `+ Add new repo...` ​​exists as sticky footer.
