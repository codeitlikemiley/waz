...
impl NewWorktreeModal {
    ...
    pub fn on_open(&mut self, cwd: Option<PathBuf>, ctx: &mut ViewContext<Self>) {
        ...
        // Just use the current session's cwd as the default. PersistedWorkspace is offline,
        // There is no longer a "last opened warehouse" to return to.
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let open_button = {
            ...
            let mut builder = appearance
                ...
                .with_text_label(crate::t!("common-open"))
                .with_style(text_button_base)
                .with_style(UiComponentStyles {
