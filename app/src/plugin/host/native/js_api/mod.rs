...
/// Returns a JS object representing the Waz Plugin API exposed to external JavaScript plugins.
///
...
/// Returns a JS object representing the Completions namespace for the Waz Plugin API.
///
/// API methods:
///
