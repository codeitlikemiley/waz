...
// Waz Wave 3-1: `AuthClient` trait and `workspace:debug_create_anonymous_user`
// debug action are physically deleted along with the auth subsystem decommission.
use crate::app_state::get_app_state;
use crate::terminal::alt_screen_reporting::AltScreenReporting;
use crate::terminal::general_settings::GeneralSettings;
use crate::workspace::cross_window_tab_drag::CrossWindowTabDrag;
// Waz Wave 3-1: `ServerApiProvider` is no longer used by this file, and `debug_create_anonymous_user`
// debug action is physically deleted along with AuthClient.
...
pub fn init_global_actions(app: &mut AppContext) {
    ...
    // Waz Wave 3-1: `workspace:debug_create_anonymous_user` global action has been
    // physically deleted along with the upstream anonymous user creation cloud entrypoint.
...
// Waz Wave 3-1: `fn create_anonymous_user` debug entrypoint has been physically deleted along with
// the upstream anonymous user creation cloud entrypoint. Waz no longer has the concept of anonymous users.
