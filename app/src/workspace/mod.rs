...
pub fn init(app: &mut AppContext) {
    ...
    view::waz_launch_modal::init(app);
    ...
    if ChannelState::enable_debug_features() {
        // Select the fluent key corresponding to the local crash description based on the platform
        ...
        #[cfg(debug_assertions)]
        {
            app.register_editable_bindings([
                ...
                .with_context_predicate(id!("Workspace")),
                EditableBinding::new(
                    "workspace:open_waz_launch_modal",
                    crate::t!("keybinding-desc-workspace-open-waz-launch-modal"),
                    WorkspaceAction::OpenWazLaunchModal,
                )
                .with_context_predicate(id!("Workspace")),
                EditableBinding::new(
                    "workspace:reset_waz_launch_modal_state",
                    crate::t!("keybinding-desc-workspace-reset-waz-launch-modal-state"),
                    WorkspaceAction::ResetWazLaunchModalState,
                )
                .with_context_predicate(id!("Workspace")),
                EditableBinding::new(
    ...
    // Decentralized branch: "Log out" command has been removed.
    ...
    app.register_editable_bindings([
        ...
        // two mac menu items for AM vs Waz AI since they are mutually exclusive.
        .with_custom_action(CustomAction::NewAgentModePane),
    ]);
...
fn add_open_setting_pages_as_editable_binding(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        ...
        .with_group(bindings::BindingGroup::Settings.as_str())
        .with_context_predicate(id!("Workspace")),
        // Waz Wave 6-8: `workspace:show_settings_shared_blocks_page` keybinding is physically deleted
        ...
        .with_group(bindings::BindingGroup::Settings.as_str())
        .with_context_predicate(id!("Workspace")),
        // Waz Wave 6-8: `workspace:show_settings_referrals_page` keybinding is physically deleted
        // along with the `ReferralsPageView` settings page.
        // Waz Wave 7-3: `workspace:show_settings_environments_page` keybinding is physically deleted
...
fn add_overflow_menu_items_as_editable_binding(app: &mut AppContext) {
    ...
    // Decentralized branch: "Invite People..." command corresponds to ShowReferralSettingsPage, has been removed.
    app.register_editable_bindings([
        EditableBinding::new(
