...
pub enum ReviewDestination {
    ...
    None,
    /// A Waz agent terminal is available (input box visible, not executing).
    Waz,
...
impl ReviewTerminalUnavailableReason {
    fn label(&self) -> &'static str {
        match self {
            ...
            Self::AIDisabled => "AI is disabled for Waz review destinations",
...
impl RightPanelView {
    pub fn init(app: &mut AppContext) {
        ...
        app.register_editable_bindings([EditableBinding::new(
            ...
            crate::t!("keybinding-desc-right-panel-toggle-maximize-code-review"),
    ...
    /// considered available (non-CLI Waz terminals require AI to be on).
            ...
            .map(|tv| {
                tv.read(ctx, |t, ctx| {
                    t.active_cli_agent(ctx)
                        ...
                        .unwrap_or(ReviewDestination::Waz)
                })
            })
