//! Waz input editor logic related to decorating the input's text, such as
...
impl Input {
    ...
    /// Highlight registered @ context references, giving them the same recognizable style as the slash command.
