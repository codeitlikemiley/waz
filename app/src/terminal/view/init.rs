...
pub fn init(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        ...
        // Waz: Delete terminal:open_share_block_modal keybinding (cloud share block)
        EditableBinding::new(
    ...
    // Waz: Delete terminal:share_current_session / terminal:stop_sharing_current_session keybindings (cloud shared session)
...
fn register_input_mode_bindings(app: &mut AppContext) {
    ...
    // Waz agent should not be tagged into a CLI agent's command, and the
