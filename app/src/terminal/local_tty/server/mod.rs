//! Logic relating to a secondary process which Waz uses to spawn new shell
//! sessions.
//!
...
//! early during Waz's initialization, we can be more confident that there are
...
/// between processes, enabling the Waz application process to communicate
