...
impl CliAgentPluginManager for ClaudeCodePluginManager {
    ...
    fn install_success_message(&self) -> &'static str {
        "Waz plugin installed. Please run /reload-plugins to activate."
    }

    fn update_success_message(&self) -> &'static str {
        "Waz plugin updated. Please run /reload-plugins to activate."
    }
...
/// Reads the installed version string for the Waz plugin, if present.
