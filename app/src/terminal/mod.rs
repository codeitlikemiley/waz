...
pub mod settings;
// Waz: Delete share_block_modal (cloud block permanent chain sharing)
...
// Waz:Delete ShareBlockModal pub use
...
pub fn init(app: &mut AppContext) {
    // Waz:Remove share_block_modal::init
    view::init(app);
}
...
impl SizeInfo {
    ...
    /// which comes from either a headless Waz instance or tests.
