...
define_settings_group!(GeneralSettings, settings: [
    show_warning_before_quitting: ShowWarningBeforeQuitting {
        ...
        description: "Whether to show a warning dialog before quitting Waz.",
    },
    quit_on_last_window_closed: QuitOnLastWindowClosed {
        ...
        description: "Whether to quit Waz when the last window is closed.",
    },
    restore_session: RestoreSession {
        ...
        description: "Whether to restore the previous session when Waz starts up.",
    },
    ...
    // One-time flag tracking whether the Waz launch modal has already been
    ...
    did_check_to_trigger_waz_launch_modal: DidShowWazLaunchModal {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
