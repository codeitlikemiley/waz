...
pub enum Event {
    ...
    PromptUpdated,
    /// Emitted when the honor_ps1 state of the shell is out-of-sync with Waz's settings.
    /// This can happen in cases such as when the user changes between PS1 and Waz prompt inside
    ...
    /// External programs can use this to trigger notifications in Waz.
    ///
    /// References:
