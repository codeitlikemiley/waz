...
fn make_new_app_menu(ctx: &AppContext) -> Menu {
    ...
    menu_items.push(MenuItem::Custom(CustomMenuItem::new(
        &crate::t!("app-menu-set-default-terminal"),
        move |ctx| {
    ...
    Menu::new(&crate::t!("app-menu-warp"), menu_items)
}
...
fn make_new_file_menu(ctx: &AppContext) -> Menu {
    ...
    Menu::new(&crate::t!("app-menu-file"), file_menu_options)
}
...
fn make_new_edit_menu(ctx: &AppContext) -> Menu {
    ...
    let group_5 = vec![
        MenuItem::Custom(CustomMenuItem::new(
            &crate::t!("app-menu-use-warp-prompt"),
        ...
        MenuItem::Custom(CustomMenuItem::new(
            &crate::t!("app-menu-copy-on-select-terminal"),
            move |ctx| {
    ...
    edit_menu_items.push(MenuItem::Custom(CustomMenuItem::new_with_submenu(
        &crate::t!("app-menu-synchronize-inputs"),
        |_| (),
        no_updates,
        None,
        vec![
    ...
    Menu::new(&crate::t!("app-menu-edit"), edit_menu_items)
}
...
fn make_new_view_menu(ctx: &AppContext) -> Menu {
    let mut items = vec![
        ...
        MenuItem::Separator,
        MenuItem::Custom(CustomMenuItem::new(
            &crate::t!("app-menu-toggle-mouse-reporting"),
            move |ctx| {
        ...
        MenuItem::Custom(CustomMenuItem::new(
            &crate::t!("app-menu-toggle-scroll-reporting"),
            move |ctx| {
        ...
        MenuItem::Custom(CustomMenuItem::new(
            &crate::t!("app-menu-toggle-focus-reporting"),
            move |ctx| {
    ...
    Menu::new(&crate::t!("app-menu-view"), items)
}
...
fn make_new_tab_menu(ctx: &AppContext) -> Menu {
    ...
    Menu::new(&crate::t!("app-menu-tab"), items)
}
...
fn make_new_ai_menu(ctx: &AppContext) -> Menu {
    ...
    Menu::new(&crate::t!("app-menu-ai"), items)
}
...
fn make_new_drive_menu(ctx: &AppContext) -> Menu {
    ...
    // Waz Phase 2a: removed `Share pane contents` menu item (cloud
    // sharing UI gone) — keeping the entry would render a clickable menu
    // item that does nothing.

    Menu::new(&crate::t!("app-menu-drive"), items)
}
...
fn block_menu_debug_items() -> Vec<MenuItem> {
    ...
    items.push(MenuItem::Custom(CustomMenuItem::new(
        &crate::t!("app-menu-show-in-band-command-blocks"),
        move |ctx| {
        ...
        move |_props, ctx| {
            let name = if BlockVisibilitySettings::handle(ctx).read(ctx, |settings, _ctx| {
                *settings.should_show_in_band_command_blocks.value()
                ...
                crate::t!("app-menu-hide-in-band-command-blocks")
            } else {
                crate::t!("app-menu-show-in-band-command-blocks")
            };
...
fn toggle_bootstrap_block_menu_item() -> MenuItem {
    MenuItem::Custom(CustomMenuItem::new(
        &crate::t!("app-menu-show-initialization-block"),
        move |ctx| {
        ...
        move |_props, ctx| {
            let name = if BlockVisibilitySettings::handle(ctx).read(ctx, |settings, _ctx| {
                *settings.should_show_bootstrap_block.value()
                ...
                crate::t!("app-menu-hide-initialization-block")
            } else {
                crate::t!("app-menu-show-initialization-block")
            };
...
fn debug_menu_items() -> Vec<MenuItem> {
    ...
    if FeatureFlag::DebugMode.is_enabled() {
        debug_menu_items.push(MenuItem::Custom(CustomMenuItem::new(
            &crate::t!("app-menu-enable-shell-debug-mode"),
            move |ctx| {
            ...
            move |_props, ctx| {
                let name = if DebugSettings::handle(ctx).read(ctx, |settings, _ctx| {
                    *settings.is_shell_debug_mode_enabled.value()
                    ...
                    crate::t!("app-menu-disable-shell-debug-mode")
                } else {
                    crate::t!("app-menu-enable-shell-debug-mode")
                };
        ...
        debug_menu_items.push(MenuItem::Custom(CustomMenuItem::new(
            &crate::t!("app-menu-enable-pty-recording"),
            move |ctx| {
                DebugSettings::handle(ctx).update(ctx, |debug_settings, ctx| {
            ...
            move |_props, ctx| {
                ...
                {
                    crate::t!("app-menu-disable-pty-recording")
                } else {
                    crate::t!("app-menu-enable-pty-recording")
                };
        ...
        debug_menu_items.push(MenuItem::Custom(CustomMenuItem::new(
            &crate::t!("app-menu-enable-in-band-generators"),
            move |ctx| {
                DebugSettings::handle(ctx).update(ctx, |debug_settings, ctx| {
            ...
            move |_props, ctx| {
                let name = if DebugSettings::handle(ctx).read(ctx, |settings, _ctx| {
                    *settings
                    ...
                    crate::t!("app-menu-disable-in-band-generators")
                } else {
                    crate::t!("app-menu-enable-in-band-generators")
                };
        ...
        debug_menu_items.push(MenuItem::Custom(CustomMenuItem::new(
            &crate::t!("app-menu-manually-toggle-network-status"),
        ...
        debug_menu_items.push(MenuItem::Custom(CustomMenuItem::new(
            &crate::t!("app-menu-export-default-settings-csv"),
            move |ctx| {
        ...
        // Waz Wave 3-1: "Create anonymous user" debug menu item was physically deleted along with the
        // `workspace:debug_create_anonymous_user` global action + AuthClient.
    }
...
fn feedback_menu_item() -> MenuItem {
    MenuItem::Custom(CustomMenuItem::new(
        &crate::t!("app-menu-send-feedback"),
        move |ctx| {
...
fn make_new_elements_menu_items(ctx: &AppContext) -> Vec<MenuItem> {
    ...
    let mut new_elements_menu = vec![
        ...
        MenuItem::Custom(CustomMenuItem::new(
            &crate::t!("keybinding-desc-workspace-new-terminal-tab"),
        ...
        MenuItem::Custom(CustomMenuItem::new(
            &crate::t!("keybinding-desc-workspace-new-agent-tab"),
    ...
    new_elements_menu.push(MenuItem::Custom(CustomMenuItem::new(
        &crate::t!("workspace-reopen-closed-session"),
        |ctx| {
    ...
    new_elements_menu.push(MenuItem::Custom(CustomMenuItem::new_with_submenu(
        &crate::t!("app-menu-launch-configurations"),
        |_| (),
...
/// Dispatch event to open a new Waz window
