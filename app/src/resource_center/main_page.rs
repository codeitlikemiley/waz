            ...
            .map(|section| match section {
                Section::Feature(data) => {
                    ...
                    let is_expanded = match data.section_name {
                        ...
                        // Expand Maximize Waz section once user has completed welcome tips,
    ...
    fn render_invite_button(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Container::new(
            appearance
                ...
                .build()
                .on_click(|_ctx, _, _| {
                    // Decentralized branch: Refer-a-friend entry point has been removed.
                })
                .finish(),
        )
