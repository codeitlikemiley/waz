...
impl SingleAxisConfig {
    ...
    pub(super) fn validate(
        &self,
        #[cfg_attr(not(debug_assertions), allow(unused_variables))] axis: Axis,
    ) {
        #[cfg(debug_assertions)]
        {
...
fn scroll_to_position_and_paint_clipped(
    ...
    // - Expanded all folders in waz drive and opened command palette (to check non-view ported elements)
