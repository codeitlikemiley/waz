...
fn test_split_path() {
    ...
    assert_eq!(
        split_path,
        SplitPath {
            directory_absolute_path: TypedPathBuf::from("/Users/warpuser/Waz.app/"),
            directory_relative_path_name: "Waz.app/".to_owned(),
    ...
    assert_eq!(
        split_path,
        SplitPath {
            directory_absolute_path: TypedPathBuf::from("/Users/warpuser/Waz.app/macOS/bin/"),
            directory_relative_path_name: "Waz.app/macOS/bin/".to_owned(),
