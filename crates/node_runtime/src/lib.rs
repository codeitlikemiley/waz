//! Node.js and npm runtime management for Waz.
//!
...
/// 3. Extract it to the Waz data directory
///
/// # Returns
...
/// 1. First, our custom Node.js installation in the Waz data directory
...
pub async fn detect_system_node(path_env_var: impl AsRef<OsStr>) -> Result<()> {
    ...
    // via Waz's inherited env rather than the captured interactive PATH.
    #[cfg(windows)]
