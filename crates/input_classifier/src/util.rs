...
/// Whether it contains CJK / Kana / Korean / full-width characters. Matching is considered non-English natural language input,
/// classified directly as AI (since the dictionary and ML models are English-only, with no CJK training samples).
