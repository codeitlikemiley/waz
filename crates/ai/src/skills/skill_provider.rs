...
//!
//! This module defines the supported skill providers (i.e. Agents, Claude, Codex, Waz) and their
...
/// Represents a skill provider/origin (Agents, Claude, Codex, or Waz).
#[derive(
    Debug,
    Clone,
    Copy,
...
pub enum SkillScope {
    ...
    #[default]
    Project,
    /// Bundled skills distributed with Waz.
    Bundled,
}
...
mod tests {
    ...
    fn warp_home_skills_path_uses_warp_home_path() {
        assert_eq!(
            home_skills_path(SkillProvider::Waz),
    ...
    fn warp_home_skill_path_uses_warp_provider() {
        ...
        assert_eq!(get_provider_for_path(&path), Some(SkillProvider::Waz));
    }
}
