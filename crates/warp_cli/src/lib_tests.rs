...
// Waz Wave 7-2: "environment" CLI is physically deleted along with the cloud ambient agent main body.
...
// Waz Wave 7-2: environment_image_list_parses / environment_create_accepts_description /
// environment_create_description_max_length / environment_update_accepts_description /
// environment_update_accepts_remove_description are physically deleted along with the cloud ambient agent main subsystem.
