...
impl IntentionSlide {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let title = appearance
            .ui_builder()
            .paragraph(localized("onboarding-intention-title", "Welcome to Waz"))
    ...
    fn render_agent_card(
        ...
        let checklist = {
            let items = [
                localized("onboarding-ai-feature-warp-agents", "Waz agents"),
                localized(
    ...
    fn render_bottom_nav(
        ...
        let new_settings_modes = FeatureFlag::WazNewSettingsModes.is_enabled();
        let next_text = if !new_settings_modes && selected_index == 1 {
            localized("common-get-warping", "Get Wazzing")
        } else {
