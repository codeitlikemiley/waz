...
impl ChannelState {
    pub fn init() -> Self {
        ...
        let app_id = AppId::new("dev", "goldcoders", "waz");
        Self {
            channel,
    ...
    ///
    /// This is a debugging tool for isolating development instances of Waz, and is not
...
/// Waz Wave 5-5: `derive_http_origin_from_ws_url` is physically deleted along with `rtc_http_url()`.
