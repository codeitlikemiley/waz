...
// Issue #72: Re-export the global proxy types from the native::proxy module to the crate root,
// allowing `app::settings::network` / `app::settings::init` to reference them directly
// via `websocket::ProxyMode`.
#[cfg(not(target_family = "wasm"))]
