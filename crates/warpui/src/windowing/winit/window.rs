...
pub(crate) struct WindowManager {
    ...
    /// We assume this won't change throughout the life of the Waz process.
...
fn maybe_adjust_window_vertically(window: &winit::window::Window) -> Option<i32> {
    ...
    // An offset of 0 is treated as the window being completely onscreen, skipping window movement and logging.
    if adjustment == 0 {
        return None;
    }
