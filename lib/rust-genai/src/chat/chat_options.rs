...
pub struct ChatOptions {
	...
	/// Waz fork extension — extra JSON object merged shallowly into the request body
...
impl ChatOptions {
	...
	/// Waz fork — see `extra_body` field doc. Pass a JSON object;
...
impl ChatOptionsSet<'_, '_> {
	...
	/// Waz fork — extra JSON body fields. See `ChatOptions::extra_body` doc.
