...
- Preserve environment isolation for Dev, Local, Integration, Waz, and development profiles.
...
- Dev, Local, Integration, Waz, and profiled builds use their own home-relative Warp config directories, such as `~/.warp-dev/skills`, `~/.warp-local/skills`, or `~/.warp-local-<profile>/skills`.
